...
"touch");null!=b&&this.$content.css(b);return this};c.prototype.restore=function(){this.stopped=!1;this.pane.show();this.addEvents()};c.prototype.reset=function(){var a,b,c,g,e,d,f;this.$el.find("."+this.options.paneClass).length||this.generate().stop();this.stopped&&this.restore();a=this.content;c=a.style;g=c.overflowY;k&&this.$content.css({height:this.$content.height()});b=a.scrollHeight+h;d=this.pane.outerHeight();f=parseInt(this.pane.css("top"),10);e=parseInt(this.pane.css("bottom"),10);e=d+f+
e;f=Math.round(e/b*e);f<this.options.sliderMinHeight?f=this.options.sliderMinHeight:null!=this.options.sliderMaxHeight&&f>this.options.sliderMaxHeight&&(f=this.options.sliderMaxHeight);"scroll"===g&&"scroll"!==c.overflowX&&(f+=h);this.maxSliderTop=e-f;this.contentHeight=b;this.paneHeight=d;this.paneOuterHeight=e;this.sliderHeight=f;this.slider.height(f);this.events.scroll();this.pane.show();this.isActive=!0;a.scrollHeight===a.clientHeight||this.pane.outerHeight(!0)>=a.scrollHeight&&"scroll"!==g?(this.pane.hide(),
this.isActive=!1):this.el.clientHeight===a.scrollHeight&&"scroll"===g?this.slider.hide():this.slider.show();this.options.alwaysVisible?this.pane.css({opacity:1,visibility:"visible"}):this.pane.css({opacity:"",visibility:""});return this};c.prototype.scroll=function(){if(this.isActive)return this.sliderY=Math.max(0,this.sliderY),this.sliderY=Math.min(this.maxSliderTop,this.sliderY),this.$content.scrollTop(-1*((this.paneHeight-this.contentHeight+h)*this.sliderY/this.maxSliderTop)),this.slider.css({top:this.sliderY}),
this};c.prototype.scrollBottom=function(a){if(this.isActive)return this.reset(),this.$content.scrollTop(this.contentHeight-this.$content.height()-a).trigger("mousewheel"),this};c.prototype.scrollTop=function(a){if(this.isActive)return this.reset(),this.$content.scrollTop(+a).trigger("mousewheel"),this};c.prototype.scrollTo=function(a){if(this.isActive)return this.reset(),a=d(a).offset().top,a>this.maxSliderTop&&(a/=this.contentHeight,this.sliderY=a*=this.maxSliderTop,this.scroll()),this};c.prototype.stop=
function(){this.stopped=!0;this.removeEvents();this.pane.hide();return this};c.prototype.flash=function(){var a=this;if(this.isActive)return this.reset(),this.pane.addClass("flashed"),setTimeout(function(){a.pane.removeClass("flashed")},this.options.flashDelay),this};d.fn.nanoScroller=function(a){return this.each(function(){var b;if(!(b=this.nanoscroller))b=d.extend({},l,a),this.nanoscroller=b=new c(this,b);if(a&&"object"===typeof a){d.extend(b.options,a);if(a.scrollBottom)return b.scrollBottom(a.scrollBottom);
if(a.scrollTop)return b.scrollTop(a.scrollTop);if(a.scrollTo)return b.scrollTo(a.scrollTo);if("bottom"===a.scroll)return b.scrollBottom(0);if("top"===a.scroll)return b.scrollTop(0);if(a.scroll&&a.scroll instanceof d)return b.scrollTo(a.scroll);if(a.stop)return b.stop();if(a.flash)return b.flash()}return b.reset()})}})(jQuery,window,document);